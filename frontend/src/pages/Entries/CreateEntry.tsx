  ...
  return (
    <div className="flex flex-col max-w-[800px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Create Tax Entry</h1>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] shadow-[0_8px_30px_-12px_rgba(0,0,0,0.08)] border border-gray-50 p-6 sm:p-10 mb-8 relative overflow-hidden">
        ...
        <div className="w-full bg-[#f4f7fa] hover:bg-[#eef2f6] rounded-[2rem] p-4 flex items-center justify-between cursor-pointer transition-all border border-transparent focus-within:border-primary/30 active:scale-[0.99]">
          <div className="flex items-center gap-4 pl-2">
            ...
            <div>
              <h3 className="font-extrabold text-gray-900 text-base">Arjun Mehta</h3>
              <p className="text-[11px] font-bold text-gray-500 tracking-wider">GST: 27AABCM1234F1Z5</p>
            </div>
          </div>
        ...
        <div className="mt-6 bg-[#f4f7fa] rounded-[2rem] py-10 px-6 flex flex-col items-center justify-center text-center">
          <p className="text-[11px] font-bold text-gray-500 uppercase tracking-[0.2em] mb-3">Current Total Tax Paid</p>
          <p className="text-4xl font-extrabold text-[#009262] tracking-tight">₹4,82,900</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] shadow-[0_8px_30px_-12px_rgba(0,0,0,0.08)] border border-gray-50 p-6 sm:p-10 mb-8 relative overflow-hidden">
        ...
        <div className="space-y-8">
          <div className="space-y-3">
            <label className="text-[11px] font-extrabold text-gray-500 uppercase tracking-[0.15em] ml-2">Tax Amount</label>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-16">
        ...
        <button className="w-full flex-1 h-[64px] bg-[#006c49] text-white font-bold text-lg rounded-[2rem] shadow-[0_12px_24px_-8px_rgba(0,108,73,0.5)] flex items-center justify-center gap-3 hover:bg-[#005a3c] transition-all active:scale-[0.98] hover:shadow-[0_16px_32px_-8px_rgba(0,108,73,0.6)]">
          <Send className="w-5 h-5 fill-current" /> 
          Create Entry & Send SMS
        </button>
      </div>
